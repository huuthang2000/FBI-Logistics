...
import com.example.demoapp.view.dialog.dom.dom_door.sale.DialogDomDoorSaleDetail;

import java.util.List;

public class PriceListDoorDomAdapter extends RecyclerView.Adapter<PriceListDoorDomAdapter.DoorViewHolder> {
    ...
    public void goToDetail(DomDoor domDoor) {
        ...
        DialogFragment dialogFragment = DialogDomDoorSaleDetail.getInstance();
    ...
    public PriceListDoorDomAdapter(Context context) {
