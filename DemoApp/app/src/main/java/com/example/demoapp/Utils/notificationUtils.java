...
import com.example.demoapp.view.driver.notifications.directReplyReceiver;
...
public class notificationUtils {
    ...
    public static void buildNotificationMessage(Context context, int notificationID, String title, String message, String idChat, fb_Chat chatDetail) {
        ...
        replyIntent.putExtra(com.example.demoapp.Utils.keyUtils.data,bundle);
        replyIntent.putExtra(com.example.demoapp.Utils.keyUtils.notificationId, notificationID);
        ...
        ContentIntent.putExtra(com.example.demoapp.Utils.keyUtils.data,bundle);
        ContentIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        PendingIntent ContentPendingIntent = PendingIntent.getActivity(context,
                0,
                ContentIntent,
        ...
        mBuilder = new NotificationCompat.Builder(context)
                .setSmallIcon(R.drawable.logofbi)
                .setContentTitle(title)
                .setContentText(message)
    ...
    public static Notification buildNotificationService(Context context){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            final String CHANNEL_ID = "Notification_fbi";
