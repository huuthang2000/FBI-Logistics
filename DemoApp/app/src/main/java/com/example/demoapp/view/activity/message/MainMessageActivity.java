package com.example.demoapp.view.activity.message;
...
import com.example.demoapp.adapter.message.RecentConversationsAdapter;
import com.example.demoapp.databinding.ActivityMainMessageBinding;
...
public class MainMessageActivity extends BaseActivity implements ConversionListener {
    ...
    private void listenCoversations() {
