...
import com.example.demoapp.view.dialog.imp.sale.FragmentImportSaleDetail;

import java.util.List;

public class PriceListImportSaleAdapter extends RecyclerView.Adapter<PriceListImportSaleAdapter.ViewHolder> {

    private Context context;
    private List<Import> listPriceList;

    public PriceListImportSaleAdapter(Context context) {
    ...
    public void goToDetail(Import imp) {
        ...
        DialogFragment dialogFragment = FragmentImportSaleDetail.getInstance();
