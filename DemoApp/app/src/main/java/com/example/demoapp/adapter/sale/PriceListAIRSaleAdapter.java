...
import com.example.demoapp.view.dialog.air.sale.FragmentAirSaleDetail;

import java.util.List;

public class PriceListAIRSaleAdapter extends RecyclerView.Adapter<PriceListAIRSaleAdapter.PriceAirViewHolder> {
    private Context context;
    private List<AirExport> listAIRS;
    private List<AirExport> mlistAirOld;

    public PriceListAIRSaleAdapter(Context context) {
    ...
    private void goToDetail(AirExport air) {
        ...
        DialogFragment dialogFragment = FragmentAirSaleDetail.getInstance();
