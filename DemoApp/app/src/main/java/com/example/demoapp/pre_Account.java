...
//
//    public pre_Account(Context context) {
//       // this.mView = mView;
...
//
//    /**
//     * viết thông tin tài khoản lên realtime database
//     *
...
//            // Phương thức hiện không được sử dụng, nhưng có thể được sử dụng nếu các giao dịch mua cần được truy vấn trong tương lai
