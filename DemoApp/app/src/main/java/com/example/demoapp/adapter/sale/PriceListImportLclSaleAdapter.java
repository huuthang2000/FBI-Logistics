...
import com.example.demoapp.view.dialog.imp.sale.FragmentImportLclSaleDetail;

import java.util.List;

public class PriceListImportLclSaleAdapter extends RecyclerView.Adapter<PriceListImportLclSaleAdapter.ViewHolder> {

    private Context context;
    private List<ImportLcl> listPriceList;

    public PriceListImportLclSaleAdapter(Context context) {
    ...
    public void goToDetail(ImportLcl imp) {
        ...
        DialogFragment dialogFragment = FragmentImportLclSaleDetail.getInstance();
