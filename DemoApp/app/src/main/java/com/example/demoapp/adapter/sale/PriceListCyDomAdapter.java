...
import com.example.demoapp.view.dialog.dom.dom_cy.sale.DialogDomCySaleDetail;

import java.util.List;

public class PriceListCyDomAdapter extends RecyclerView.Adapter<PriceListCyDomAdapter.CyViewHolder> {
    ...
    public void goToDetail(DomCy domCy) {
        ...
        DialogFragment dialogFragment = DialogDomCySaleDetail.getInstance();
    ...
    public PriceListCyDomAdapter(Context context) {
