...
import com.example.demoapp.view.dialog.dom.dom_dry.sale.DialogDomDrySaleDetail;

import java.util.List;

public class PriceListDryDomAdapter extends RecyclerView.Adapter<PriceListDryDomAdapter.DryViewHolder> {
    ...
    public void goToDetail(DomDry domDry) {
        ...
        DialogFragment dialogFragment = DialogDomDrySaleDetail.getInstance();
    ...
    public PriceListDryDomAdapter(Context context) {
