...
import com.example.demoapp.view.dialog.dom.dom_door_sea.sale.DomDoorSeaSaleDetail;

import java.util.List;

public class PriceListDoorSeaDomAdapter extends RecyclerView.Adapter<PriceListDoorSeaDomAdapter.DoorSeaViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull DoorSeaViewHolder holder, int position) {
    ...
    public void goToDetail(DomDoorSea domDoorSea) {
        ...
        DialogFragment dialogFragment = DomDoorSeaSaleDetail.getInstance();
    ...
    public PriceListDoorSeaDomAdapter(Context context) {
