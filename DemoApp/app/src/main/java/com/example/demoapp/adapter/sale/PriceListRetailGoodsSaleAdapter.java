...
import com.example.demoapp.view.dialog.air.sale.FragmentRetailExportSaleDetail;

import java.util.List;

public class PriceListRetailGoodsSaleAdapter extends  RecyclerView.Adapter<PriceListRetailGoodsSaleAdapter.PriceRetialGoodsViewHolder>{
    private Context context;
    private List<RetailGoods> listRetailGoods;

    public  PriceListRetailGoodsSaleAdapter(Context context){
...
//            holder.tvNote.setText(priceRetailGoods.getNote());
    ...
    private void goToDetail(RetailGoods retailGoods){
        ...
        DialogFragment dialogFragment = FragmentRetailExportSaleDetail.getInstance();
