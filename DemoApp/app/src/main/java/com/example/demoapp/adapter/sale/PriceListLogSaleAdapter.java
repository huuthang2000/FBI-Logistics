...
import com.example.demoapp.view.dialog.log.sale.FragmentLogSaleDetail;

import java.util.List;

public class PriceListLogSaleAdapter extends RecyclerView.Adapter<PriceListLogSaleAdapter.LogViewHolder> {
    private Context context;
    private List<Log> mPriceListLog;

    public PriceListLogSaleAdapter(Context context){
    ...
    private void goToDetail(Log log1) {
        ...
        DialogFragment dialogFragment = FragmentLogSaleDetail.getInstance();
