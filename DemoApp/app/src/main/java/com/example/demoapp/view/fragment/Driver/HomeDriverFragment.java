package com.example.demoapp.view.fragment.Driver;
...
public class HomeDriverFragment extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerDragListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.fragment_home_driver );
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            if (addresses.size () > 0) {
                ...
                LatLng london = new LatLng ( 10, 106 );
                markerOptions = new MarkerOptions ()
                        .position ( london )
                        .title ( address.getLocality () );

                mMap.addMarker ( markerOptions );
                mMap.moveCamera ( CameraUpdateFactory.newLatLngZoom ( london, 20 ) );
            }
        } catch (IOException e) {
            e.printStackTrace ();
        }
