...
import com.example.demoapp.databinding.ItemContainerReceivedMessageBinding;
import com.example.demoapp.databinding.ItemContainerSentMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final int VIEW_TYPE_SENDT = 1;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(getItemViewType(position) == VIEW_TYPE_SENDT){
