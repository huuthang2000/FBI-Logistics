...
import com.example.demoapp.view.dialog.dom.dom_import.sale.DialogDomImportSaleDetail;

import java.util.List;

public class PriceListImportDomAdapter extends RecyclerView.Adapter<PriceListImportDomAdapter.ImportViewHolder> {
    ...
    public void goToDetail(DomImport domImport){
        ...
        DialogFragment dialogFragment = DialogDomImportSaleDetail.getInstance();
    ...
    public PriceListImportDomAdapter(Context context) {
