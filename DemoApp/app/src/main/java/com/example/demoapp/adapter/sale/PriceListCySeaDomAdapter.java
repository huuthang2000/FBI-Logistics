...
import com.example.demoapp.view.dialog.dom.dom_cy_sea.sale.CySeaSaleDetail;

import java.util.List;

public class PriceListCySeaDomAdapter extends RecyclerView.Adapter<PriceListCySeaDomAdapter.CySeaViewHolder> {
    ...
    public void goToDetail(DomCySea domCySea) {
        ...
        DialogFragment dialogFragment = CySeaSaleDetail.getInstance();
    ...
    public PriceListCySeaDomAdapter(Context context) {
